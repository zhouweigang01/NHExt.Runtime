...
{
    public static class ChineseConvertion
    {
...
, { -10256, "zun" }, { -10254, "zuo" } };
        ...
        /// <param name="isAppendCode">是否将首字母追加到拼音结果中</param>
        /// <returns></returns>
        public static string ChineseToSpell(string txt, bool isAppendCode)
        {
            txt = txt.Trim();
            ...
            if (isAppendCode)
            {
                return result.ToString() + "," + ChineseToSpellCode(txt);
            }
        ...
        public static string ChineseToSpellCode(string cnStr)
        {
            string strTemp = "";
