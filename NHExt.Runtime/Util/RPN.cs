                ...
                else
                {
                    switch (((Operator)item).Type)
                    {
                        ...
                        case OperatorType.MUL:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("乘运算的两个操作数必须均为数字");
                            }
                            break;
                        #endregion
                        ...
                        case OperatorType.DIV:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("除运算的两个操作数必须均为数字");
                            }
                            break;
                        #endregion
                        ...
                        case OperatorType.MOD:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("余运算的两个操作数必须均为数字");
                            }
                            break;
                        #endregion
                        ...
                        case OperatorType.ADD:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("加运算的两个操作数必须均为数字");
                            }
                            break;
                        #endregion
                        ...
                        case OperatorType.SUB:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("减运算的两个操作数必须均为数字");
                            }
                            break;
                        #endregion
                        ...
                        case OperatorType.TAN:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("正切运算的1个操作数必须均为角度数字");
                            }
                            break;
                        #endregion
                        ...
                        case OperatorType.ATAN:
                            ...
                            {
                                throw new NHExt.Runtime.Exceptions.RuntimeException("反正切运算的1个操作数必须均为数字");
                            }
                            break;
                        #endregion
